 ...
 *  children
 */
function DropdownPanel({ placement = 'bottom-start', offset = 8, anchor, component: Comp, children, ...rest }) {
  const resolvedOffset = typeof offset === 'string' ? parseFloat(offset) : offset;
  const { isOpen, triggerRef, fireEvent, hasNav, darkMode } = useDropdownContext();
